...
var PugRuntime = function () {
  ...
  PugRuntime.prototype.attrs = function attrs(target, _attrs) {
    ...
    if (_attrs.class) {
      _attrs.class = this.attr(_attrs.class);
    }
    for (var attr in _attrs) {
      if (_attrs[attr] === false || _attrs[attr] == null) continue;
  ...
  PugRuntime.prototype.mixin = function mixin(parent, self, _mixin) {
    for (var _len = arguments.length, args = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
      args[_key - 3] = arguments[_key];
    }

    this.child(parent, _mixin.call(Object.assign.apply(Object, [Object.create(self)].concat(args))));
  };
