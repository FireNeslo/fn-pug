...
var _transformContext = require('./helpers/transform-context');

var _transformContext2 = _interopRequireDefault(_transformContext);
...
class Compiler {
  compileSource(ast, options = {}) {
    ...
    this.ast = ast;
    this.map = new _sourceMap.SourceMapGenerator({ file: this.file });
    this.code = '';
    this.uid = 0;
  ...
  compile(tree, options) {
    ...
    const { code, ast, map } = (0, _transformContext2.default)(this.code, this.map);
